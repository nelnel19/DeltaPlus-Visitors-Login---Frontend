...
const CITIES_BY_REGION = {
  ...
  III: [
    ...
    { value: "San Jose del Monte", label: "San Jose del Monte" }, { value: "Tarlac City", label: "Tarlac City" }, { value: "Subic", label: "Subic" },
    { value: "Baler", label: "Baler" }, { value: "Casiguran", label: "Casiguran" }, { value: "Dilasag", label: "Dilasag" },
    { value: "Dinalungan", label: "Dinalungan" }, { value: "Dingalan", label: "Dingalan" }, { value: "Dipaculao", label: "Dipaculao" },
    { value: "Maria Aurora", label: "Maria Aurora" }, { value: "San Luis", label: "San Luis" }, { value: "Abucay", label: "Abucay" },
    { value: "Bagac", label: "Bagac" }, { value: "Dinalupihan", label: "Dinalupihan" }, { value: "Hermosa", label: "Hermosa" },
    { value: "Limay", label: "Limay" }, { value: "Mariveles", label: "Mariveles" }, { value: "Morong", label: "Morong" },
    { value: "Orani", label: "Orani" }, { value: "Orion", label: "Orion" }, { value: "Pilar", label: "Pilar" },
    { value: "Samal", label: "Samal" }, { value: "Angat", label: "Angat" }, { value: "Balagtas", label: "Balagtas" },
    { value: "Baliwag", label: "Baliwag" }, { value: "Bocaue", label: "Bocaue" }, { value: "Bulakan", label: "Bulakan" },
    { value: "Bustos", label: "Bustos" }, { value: "Calumpit", label: "Calumpit" }, { value: "Doña Remedios Trinidad", label: "Doña Remedios Trinidad" },
    { value: "Guiguinto", label: "Guiguinto" }, { value: "Hagonoy", label: "Hagonoy" }, { value: "Marilao", label: "Marilao" },
    { value: "Norzagaray", label: "Norzagaray" }, { value: "Obando", label: "Obando" }, { value: "Pandi", label: "Pandi" },
    { value: "Paombong", label: "Paombong" }, { value: "Plaridel", label: "Plaridel" }, { value: "Pulilan", label: "Pulilan" },
    { value: "San Ildefonso", label: "San Ildefonso" }, { value: "San Miguel", label: "San Miguel" }, { value: "San Rafael", label: "San Rafael" },
    { value: "Santa Maria", label: "Santa Maria" }, { value: "Aliaga", label: "Aliaga" }, { value: "Bongabon", label: "Bongabon" },
    { value: "Cabiao", label: "Cabiao" }, { value: "Carranglan", label: "Carranglan" }, { value: "Cuyapo", label: "Cuyapo" },
    { value: "Gabaldon", label: "Gabaldon" }, { value: "General Mamerto Natividad", label: "General Mamerto Natividad" }, { value: "General Tinio", label: "General Tinio" },
    { value: "Guimba", label: "Guimba" }, { value: "Jaen", label: "Jaen" }, { value: "Laur", label: "Laur" },
    { value: "Licab", label: "Licab" }, { value: "Llanera", label: "Llanera" }, { value: "Lupao", label: "Lupao" },
    { value: "Nampicuan", label: "Nampicuan" }, { value: "Pantabangan", label: "Pantabangan" }, { value: "Peñaranda", label: "Peñaranda" },
    { value: "Quezon", label: "Quezon" }, { value: "Rizal", label: "Rizal" }, { value: "San Antonio", label: "San Antonio" },
    { value: "San Isidro", label: "San Isidro" }, { value: "San Leonardo", label: "San Leonardo" }, { value: "Santa Rosa", label: "Santa Rosa" },
    { value: "Santo Domingo", label: "Santo Domingo" }, { value: "Talavera", label: "Talavera" }, { value: "Talugtug", label: "Talugtug" },
    { value: "Zaragoza", label: "Zaragoza" }, { value: "Apalit", label: "Apalit" }, { value: "Arayat", label: "Arayat" },
    { value: "Bacolor", label: "Bacolor" }, { value: "Candaba", label: "Candaba" }, { value: "Floridablanca", label: "Floridablanca" },
    { value: "Guagua", label: "Guagua" }, { value: "Lubao", label: "Lubao" }, { value: "Macabebe", label: "Macabebe" },
    { value: "Magalang", label: "Magalang" }, { value: "Masantol", label: "Masantol" }, { value: "Mexico", label: "Mexico" },
    { value: "Minalin", label: "Minalin" }, { value: "Porac", label: "Porac" }, { value: "San Luis", label: "San Luis" },
    { value: "San Simon", label: "San Simon" }, { value: "Santa Ana", label: "Santa Ana" }, { value: "Santa Rita", label: "Santa Rita" },
    { value: "Santo Tomas", label: "Santo Tomas" }, { value: "Sasmuan", label: "Sasmuan" }, { value: "Anao", label: "Anao" },
    { value: "Bamban", label: "Bamban" }, { value: "Camiling", label: "Camiling" }, { value: "Capas", label: "Capas" },
    { value: "Concepcion", label: "Concepcion" }, { value: "Gerona", label: "Gerona" }, { value: "La Paz", label: "La Paz" },
    { value: "Mayantoc", label: "Mayantoc" }, { value: "Moncada", label: "Moncada" }, { value: "Paniqui", label: "Paniqui" },
    { value: "Pura", label: "Pura" }, { value: "Ramos", label: "Ramos" }, { value: "San Clemente", label: "San Clemente" },
    { value: "San Jose", label: "San Jose" }, { value: "San Manuel", label: "San Manuel" }, { value: "Santa Ignacia", label: "Santa Ignacia" },
    { value: "Victoria", label: "Victoria" }, { value: "Botolan", label: "Botolan" }, { value: "Cabangan", label: "Cabangan" },
    { value: "Candelaria", label: "Candelaria" }, { value: "Castillejos", label: "Castillejos" }, { value: "Iba", label: "Iba" },
    { value: "Masinloc", label: "Masinloc" }, { value: "Palauig", label: "Palauig" }, { value: "San Antonio", label: "San Antonio" },
    { value: "San Felipe", label: "San Felipe" }, { value: "San Marcelino", label: "San Marcelino" }, { value: "San Narciso", label: "San Narciso" },
